...
private:
    ...
    std::vector<client *> clients; // clients in the channel
    std::vector<client *> operators; // operators in the channel --> @admine == the first who create the channel
    std::vector<client *> invites; // invited clients in the channel --> MODE +i
